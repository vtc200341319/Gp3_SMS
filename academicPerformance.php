        ...
        <table>
            ...
            <?php
                ...
                foreach ($grades as $course => $grade) {
                    $credits = 3; // Assume all courses are 3 credit hours
                ...
                function get_course_title($course_code) {
                    // Add code to retrieve course titles from a database or an array
                    switch ($course_code) {
                        case "Math":
                            return "Mathematics";
                        case "English":
                ...
                echo "<tr><td></td><td><b>GPA:</b></td><td><b>" . number_format($gpa, 2) . "</b><td></td></tr>";
            ?>
        </table>
    </div>
