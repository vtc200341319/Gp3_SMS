...
CREATE TABLE IF NOT EXISTS `login` (
  ...
  `LastPwdChangeDate` datetime DEFAULT NULL,
  PRIMARY KEY (`loginID`),
  UNIQUE KEY `unique_loginName` (`loginName`)
) ENGINE=MyISAM AUTO_INCREMENT=20230006 DEFAULT CHARSET=latin1;

--
-- Dumping data for table `login`
--

INSERT INTO `login` (`loginID`, `type`, `loginName`, `loginEmail`, `loginPassword`, `securityQ`, `securityAns`, `state`, `LastPwdChangeDate`) VALUES
(20000001, 'A', 'operator1', 'operator1@sms.edu.hk', '161ebd7d45089b3446ee4e0d86dbcf92', '2', '4b583376b2767b923c3e1da60d10de59', 'Active', '2023-07-04 11:23:08'),
(20000002, 'S', 'student1', '200341319@stu.vtc.edu.hk', '161ebd7d45089b3446ee4e0d86dbcf92', '2', '9ab1c5afa4946ca0040271736f38c83a', 'Active', '2023-05-23 17:44:41'),
(20000003, 'A', 'operator2', 'oper@sms.com', '161ebd7d45089b3446ee4e0d86dbcf92', '2', '4b583376b2767b923c3e1da60d10de59', 'Active', NULL),
(20230002, 'P', 'p20230001', 'p20230001@sms.com', '161ebd7d45089b3446ee4e0d86dbcf92', '', '', 'Active', '2023-05-23 16:11:32'),
(20230001, 'S', 's20230001', 's20230001@sms.com', 'b44effb557163b8985333a4feb65af5d', '', '', 'Active', NULL),
(20230003, 'T', 'teacher1', '20230003@sms.com', '161ebd7d45089b3446ee4e0d86dbcf92', '2', '8d788385431273d11e8b43bb78f3aa41', 'Active', NULL);
...
(65, 20220001, 'A', 'operator1', 'success', '2023-05-22 17:35:26', ''),
(66, 20230001, 'S', 's20230001', 'success', '2023-05-22 17:55:49', ''),
(67, 20220001, 'A', 'operator1', 'fail', '2023-05-23 12:59:33', 'wrong password'),
(68, 20220001, 'A', 'operator1', 'success', '2023-05-23 12:59:42', ''),
(69, 20220002, 'S', 'student1', 'success', '2023-05-23 13:08:59', ''),
(70, 20220002, 'S', 'student1', 'fail', '2023-05-23 13:09:05', 'wrong password'),
(71, 20220001, 'A', 'operator1', 'success', '2023-05-23 13:09:11', ''),
(72, 20220002, 'S', 'student1', 'success', '2023-05-23 13:21:11', ''),
(73, 20220002, 'S', 'student1', 'fail', '2023-05-23 13:35:17', 'wrong password'),
(74, 20220002, 'S', 'student1', 'success', '2023-05-23 15:42:07', ''),
(75, 20220002, 'S', 'student1', 'fail', '2023-05-23 15:54:55', 'wrong password'),
(76, 20220002, 'S', 'student1', 'success', '2023-05-23 15:55:01', ''),
(77, 20220002, 'S', 'student1', 'fail', '2023-05-23 16:01:48', 'wrong password'),
(78, 20220002, 'S', 'student1', 'fail', '2023-05-23 16:01:51', 'wrong password'),
(79, 20220002, 'S', 'student1', 'fail', '2023-05-23 16:01:54', 'wrong password'),
(80, 20220002, 'S', 'student1', 'fail', '2023-05-23 16:01:57', 'wrong password'),
(81, 20220002, 'S', 'student1', 'fail', '2023-05-23 16:01:57', 'fail 5 times account lock'),
(82, 20220002, 'S', 'student1', 'success', '2023-05-23 16:02:39', ''),
(83, 20220001, 'A', 'operator1', 'success', '2023-05-23 16:02:49', ''),
(84, 20000001, 'A', 'operator1', 'success', '2023-05-23 16:05:07', ''),
(85, 20230002, 'P', 'p20230001', 'success', '2023-05-23 17:13:02', ''),
(86, 20230002, 'P', 'p20230001', 'success', '2023-05-23 18:15:24', ''),
(87, 20000001, 'A', 'operator1', 'success', '2023-05-29 16:44:20', ''),
(88, 20000001, 'A', 'operator1', 'success', '2023-05-29 17:11:01', ''),
(89, 20000001, 'A', 'operator1', 'success', '2023-05-30 15:36:30', ''),
(90, 20230003, 'T', 'teacher1', 'success', '2023-05-30 15:42:34', ''),
(91, 20000001, 'A', 'operator1', 'success', '2023-05-30 16:07:02', ''),
(92, 20000001, 'A', 'operator1', 'success', '2023-05-31 12:18:17', ''),
(93, 20000001, 'A', 'operator1', 'success', '2023-05-31 12:25:43', ''),
(94, 20000001, 'A', 'operator1', 'success', '2023-05-31 12:30:19', ''),
(95, 20000001, 'A', 'operator1', 'fail', '2023-05-31 12:37:49', 'wrong password'),
(96, 20000001, 'A', 'operator1', 'success', '2023-05-31 12:37:56', ''),
(97, 20000001, 'A', 'operator1', 'success', '2023-05-31 12:42:36', ''),
(98, 20000001, 'A', 'operator1', 'success', '2023-05-31 12:44:57', ''),
(99, 20000001, 'A', 'operator1', 'success', '2023-05-31 12:45:54', ''),
(100, 20000001, 'A', 'operator1', 'success', '2023-05-31 12:48:39', ''),
(101, 20000001, 'A', 'operator1', 'success', '2023-05-31 13:55:01', ''),
(102, 20000001, 'A', 'operator1', 'success', '2023-05-31 16:03:08', ''),
(103, 20000001, 'A', 'operator1', 'success', '2023-06-23 12:33:37', ''),
(104, 20000001, 'A', 'operator1', 'success', '2023-06-23 12:41:43', ''),
(105, 20000001, 'A', 'operator1', 'success', '2023-07-03 12:16:21', ''),
(106, 20000001, 'A', 'operator1', 'success', '2023-07-03 13:14:30', ''),
(107, 20000001, 'A', 'operator1', 'success', '2023-07-03 13:53:45', ''),
(108, 20000001, 'A', 'operator1', 'fail', '2023-07-04 11:22:53', 'wrong password'),
(109, 20000001, 'A', 'operator1', 'success', '2023-07-04 11:23:16', '');
...
CREATE TABLE IF NOT EXISTS `payment` (
  ...
  `authorizedCode` varchar(10) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `eNoticeNumber` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `studentRegNumber` int NOT NULL,
...
INSERT INTO `payment` (`PaymentID`, `paymentMethod`, `total`, `status`, `payDT`, `expiryDate`, `authorizedCode`, `eNoticeNumber`, `studentRegNumber`) VALUES
(1, 'VISA', 30, 'success', '0000-00-00 00:00:00', '2023/05', '668', 'A01', 201800001),
(2, 'CASH', 30, 'success', NULL, NULL, NULL, 'A01', 201800002),
(3, 'credit-card', 20, 'fail', '2023-07-03 00:00:00', NULL, '2xeW35', '', 20000001),
(4, 'credit-card', 30, 'success', '2023-07-03 00:00:00', NULL, 'e93fp80r', '', 20000001),
(5, 'credit-card', 50, 'success', '2023-07-03 00:00:00', NULL, '7twffswc', '', 20000001),
(6, 'credit-card', 30, 'success', '2023-07-03 00:00:00', NULL, 'rdy6r5q1', '', 20000001),
(7, 'credit-card', 25, 'success', '2023-07-03 05:27:53', NULL, 'n4j226tf', '', 20000001),
(8, 'credit-card', 20, 'success', '2023-07-03 05:35:03', NULL, '4k4vmmz1', '', 20000001);
...
(1, '2023-06-30', '2023-07-13', 'Which festival day you like the most?', 'Easter', 'Mid-Autumn Festival', 'Lunar New Year ', 'Christmas', 'ALL', NULL, 0, 0, 0, 0),
(2, '2023-07-01', '2023-07-20', 'What is your favorite color?', 'Red', 'Blue', 'Green', 'Yellow', 'ALL', NULL, 99, 302, 70, 121),
(3, '2023-07-03', '2023-07-25', 'What is your favorite food?', 'Pizza', 'Sushi', 'Burger', 'Fried chicken', 'ALL', NULL, 0, 0, 0, 0),
(4, '2023-07-04', '2023-07-28', 'What is your favorite season?', 'Spring', 'Summer', 'Fall', 'Winter', 'ALL', NULL, 0, 0, 0, 0),
(5, '2023-07-05', '2023-08-25', 'What is your favorite animal?', 'Dog', 'Cat', 'Horse', 'Rabbit', 'ALL', NULL, 0, 0, 0, 0);
...
INSERT INTO `staff` (`staffID`, `loginID`, `staffCode`, `staffEngName`, `staffChiName`, `staffSex`, `staffJobTitle`, `staffDateOfBirth`, `staffDateOfEmployment`, `staffPlaceOfBirth`, `staffAddress`, `staffPhoneNumber`) VALUES
(1, NULL, 'CHOWTL', 'CHOW Tsz Long', '周子朗', 'Male', 'Teacher', '1991-06-07', '2020-09-01', 'Hong Kong', 'Hong Kong', 65125236),
(2, NULL, 'HOTC', 'HO Tsz Ching', '何芷晴', 'Female', 'Teacher', '1995-08-09', '2022-09-01', 'Hong Kong', 'Hong Kong', 66336347),
(3, NULL, 'YEUNGTL', 'YEUNG Tin Long', '楊天朗', 'Male', 'Teacher', '1985-04-08', '2008-09-01', 'Hong Kong', 'Hong Kong', 56985692),
(4, NULL, 'LIWL', 'LI Wing Lam', '李詠琳', 'Female', 'Teacher', '1988-06-12', '2009-09-01', 'Hong Kong', 'Hong Kong', 58556369),
(5, NULL, 'CHANKL', 'CHAN Ka Lok', '陳家樂', 'Male', 'Clerk', '1996-02-28', '2021-09-01', 'Hong Kong', 'Hong Kong', 95678596),
(6, NULL, 'LEEWT', 'LEE Wing Tung', '李穎彤', 'Female', 'Clerk', '1990-06-22', '2019-09-01', 'Hong Kong', 'Hong Kong', 69563698),
(7, NULL, 'WONGPH', 'WONG Pak Hei', '黃柏晞', 'Male', 'IT Coordinator', '1994-05-22', '2018-09-01', 'Hong Kong', 'Hong Kong', 98563695),
(8, 20000001, 'CHANCH', 'CHAN Chun Hei', '陳俊熙', 'Male', 'IT Assistant', '1991-07-10', '2018-09-01', 'Hong Kong', 'Hong Kong', 91203563);
...
(25, 's20230001', 'CHAN Ka Hei', '陳家希', 'Male', '2013-05-02', 'Hong Kong', 'Hong Kong', 1, 'B', 'p20230001');
