...
<html>
    ...
    <body>       
        <h1 class="en" lang="en">School Management System - Menu  <span class="clock" id="clock"></span></h1>
        <h1 class="zh" lang="zh">學校管理系統 - 目錄  <span class="clock" id="clock1"></span></h1>
        ...
        <p class="en" lang="en">Today is <?php echo date('F j, Y'); ?>.</p>
        <p class="zh" lang="zh">今天是 <?php echo date('Y年m月d日'); ?></p>

        <div class = "en" lang = "en">
            <div class = "tab">
                <button class = "tablinks active" data-target = "home" onclick="reloadPage()"><img src = "img/icon/home.png" alt = "Home" width = "35" height = "35">&nbsp;
                    Home </button>
                ...
                <?php
                if ($_SESSION['type'] == 'A') {
                    echo'<button class = "tablinks" data-target = "school"><img src = "img/icon/schoolCenter.png" alt = "School Centre" width = "35" height = "35">&nbsp;
        ...
        <div id="home" class="tabcontent show">
            <span class="en" lang="en"><?php echo "Welcome, " . $_SESSION['loginID']; ?>.</span>
            <span class="zh" lang="zh"><?php echo "歡迎, " . $_SESSION['loginID']; ?>.</span>

            <div class="inner-div">
                <table>
                    <tr>
                        <td class="iframtd">
                            <iframe src="home.php?_=<?php echo time(); ?>" title="Home" name="iframe_home" style="width: 100%; height: 698px; border: none;"></iframe>
                        </td>
                    </tr>
                </table>
            </div>
                ...
                <tr>
                    <td class="menu">
                        ...
                        <div class="accordion">                            
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <a href="page/campus/teachAnnouncement.php" target="ifeame_campus" class="en" lang="en">Teacher Announcement</a>
                                    <a href="page/campus/teachAnnouncement.php " target="ifeame_campus" class="zh" lang="zh">班主任宣佈</a>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header">                                
                                    <a href="page/campus/notice/onlineNotice.php" target="ifeame_campus" class="en" lang="en">Online Notice</a>
                                    <a href="page/campus/notice/onlineNotice.php" target="ifeame_campus" class="zh" lang="zh">電子通告</a>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header">
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    ...
                                    <a href="page/campus/imail.php" target="ifeame_campus" class="zh" lang="zh">電郵服務</a>                 
                                </div>                
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div class="accordion-content">                                
                                    ...
                                    <a href="page/campus/activityregistration.php" target="ifeame_campus" class="zh" lang="zh">活動報名</a>         
                            ...
                            <div class="accordion-item">
                                ...
                                <div class="accordion-content">                                   
                                    <a href="page/campus/calendar/schoolCalendar.php" target="ifeame_campus" class="en" lang="en">School Calendar</a>
                                    <a href="page/campus/calendar/schoolCalendar.php" target="ifeame_campus" class="zh" lang="zh">校曆表</a>                                      
                                    <p><a href="page/campus/academicPerformance.php" target="ifeame_campus" class="en" lang="en">Academic Performance</a>
                                        <a href="page/campus/academicPerformance.php" target="ifeame_campus" class="zh" lang="zh">學業成續單</a> </p>                                    
                                </div>
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div class="accordion-content">
                                    <a href="payment_record.php" target="ifeame_campus" class="en" lang="en">Payment Record</a>
                                    <a href="payment_record.php" target="ifeame_campus" class="zh" lang="zh">繳費紀錄</a>     
                                    <p><a href="payment_page.php" target="ifeame_campus" class="en" lang="en">Payment</a>
                                        <a href="payment_page.php" target="ifeame_campus" class="zh" lang="zh">繳交費用</a>     </p>             
                                </div>
                            </div>
                        </div>                       
                    </td>                    
                    ...
                    <td class="menu">
                        ...
                        <div class="accordion">
                            <div class="accordion-item">
                                ...
                                <div class="accordion-content">
                                    <a href="page/schoolcentre/brBook.php" target="ifeame_center" class="en" lang="en">Borrowing & Returning Records</a>
                                    <a href="page/schoolcentre/brBook.php" target="ifeame_center" class="zh" lang="zh">圖書借還紀錄</a>  
                                    ...
                                    <p><a href="page/schoolcentre/rBook.php" target="ifeame_center" class="en" lang="en">Book Reserve</a>
                                        <a href="page/schoolcentre/rBook.php" target="ifeame_center" class="zh" lang="zh">預約借書</a>  </p>                                   
                                </div>
                            </div>

                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <a href="page/schoolcentre/usefulWeb.php" target="ifeame_center" class="en" lang="en">Useful Website</a>
                                    <a href="page/schoolcentre/usefulWeb.php" target="ifeame_center" class="zh" lang="zh">常用網站</a>     
                                </div>
                            </div>

                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <a href="page/schoolcentre/onlineResource.php" target="ifeame_center" class="en" lang="en">Online Resource</a>
                                    <a href="page/schoolcentre/onlineResource.php" target="ifeame_center" class="zh" lang="zh">網上資源</a>
                                </div>                               
                            </div>                            
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <a href="page/schoolcentre/homework.php" target="ifeame_center" class="en" lang="en">Homework</a>
                                    <a href="page/schoolcentre/homework.php" target="ifeame_center" class="zh" lang="zh">家課冊</a>             
                                </div>
                            </div> 
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <a href="page/schoolcentre/eclass.php" target="ifeame_center" class="en" lang="en">e-Classroom</a>
                                    <a href="page/schoolcentre/eclass.php" target="ifeame_center" class="zh" lang="zh">網上教室</a>             
                                </div>
                            </div> 
                            <div class="accordion-item">
                                <div class="accordion-header">
                ...
                <tr>
                    <td class="menu">
                        ...
                        <div class="accordion">
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <a href="page/workplace/teacherPlan.php" target="ifeame_teacher" class="en" lang="en">Teaching Plan</a>
                                    <a href="page/workplace/teacherPlan.php" target="ifeame_teacher"  class="zh" lang="zh">教學方案</a>  
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header">
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <a href="page/workplace/exampaper.php" target="ifeame_teacher" class="en" lang="en">Exam paper</a>
                                    <a href="page/workplace/exampaper.php" target="ifeame_teacher" class="zh" lang="zh">試卷</a>  
                                </div>
                            </div> 
                            <div class="accordion-item">
                                <div class="accordion-header">
                    ...
                    <td class="menu">
                        ...
                        <div class="accordion">
                            ...
                            <div class="accordion-item">
                                ...
                                <div class="accordion-content">
                                    <a href="page/admin/subject.php" target="ifeame_admin" class="en" lang="en">Registered Subjects</a>
                                    <a href="page/admin/subject.php" target="ifeame_admin" class="zh" lang="zh">註冊科目</a>  
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <a href="page/admin/schoolAttendance.php" target="ifeame_admin" class="en" lang="en">School Attendance Record</a>
                                    <a href="page/admin/schoolAttendance.php" target="ifeame_admin" class="zh" lang="zh">校勤紀錄</a>                                    
                                </div>                              
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <a href="page/admin/uploadNotice.php" target="ifeame_admin" class="en" lang="en">eNotice</a>
                                    <a href="page/admin/uploadNotice.php" target="ifeame_admin"  class="zh" lang="zh">電子通告匯入</a>                                    
                                </div>                              
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <a href="page/schoolcentre/homework.php" target="ifeame_admin" class="en" lang="en">Homework</a>
                                    <a href="page/schoolcentre/homework.php" target="ifeame_admin" class="zh" lang="zh">家課匯入</a>                                    
                                </div>                              
                            </div>
                            ...
                            <div class="accordion-item">
                                ...
                                <div class="accordion-content">
                                    <a href="page/admin/gentData.php" target="ifeame_admin" class="en" lang="en">Personal Information</a>
                                    <a href="page/admin/gentData.php" target="ifeame_admin" class="zh" lang="zh">個人詳細資料</a>                                     
                                </div>
                            </div>
                ...
                <tr>
                    <td class="menu">
                        ...
                        <div class="accordion">
                            ...
                            <div class="accordion-item">
                                <div class="accordion-header">
                                    <a href="page/profile/selfAttendence.php" target="ifeame_pro" class="en" lang="en">School Attendance Record</a>
                                    <a href="page/profile/selfAttendence.php" target="ifeame_pro" class="zh" lang="zh">校勤紀錄</a>  
                                </div>
                            </div>
                            <div class="accordion-item">
                                <div class="accordion-header">
                                ...
                                <div class="accordion-content">
                                    <a href="page/profile/personalinfo.php" target="ifeame_pro" class="en" lang="en">Personal Information</a>
                                    <a href="page/profile/personalinfo.php" target="ifeame_pro"  class="zh" lang="zh">個人詳細資料</a>                                       
                                    <p>
                                        <a href="page/profile/upDateProfile.html" target="ifeame_pro"  class="en" lang="en">Update Personal Information</a>
                                        <a href="page/profile/upDateProfile.html" target="ifeame_pro"  class="zh" lang="zh">更新個人詳細資料</a>   
                                    </p>
                                </div>
                            </div>
                            <div class="accordion-item">
                                ...
                                <div class="accordion-content">
                                    <a href="page/profile/uploadMC.php" target="ifeame_pro" class="en" lang="en">Medical Certificate</a>
                                    <a href="page/profile/uploadMC.php" target="ifeame_pro"  class="zh" lang="zh">醫療證明</a>                                                                       
                                </div>
                            </div>
                        </div>
                    ...
                    <td class="iframtd">
                        <iframe src="" title="Profile" name = 'ifeame_pro'></iframe>
                    </td>
                </tr>
            </table>
        </div>
